    ...
    actions: {
        connect() {
            this.experience_data = [
                {
                    rol: "Software Engineer, Oversonic Robotics",
                    date: "Sep. 2022 - NOW",
                    place: "Milan, Italy",
                    info: ["Managed the full lifecycle of humanoid robotic platforms, engineering integrated tools for configuration, real-time control, and telemetry monitoring.",
                    ],
                    star: true
                },
                {
                    ...
                    info: ["Added new infrastructure into their food recognition app to take into account custom recipes created by nutrionists.",
                        "Worked with Flask, MySQL, Git, Docker, HTML, CSS and Javascript. "]
                }, {
                    rol: "Data Scientist",
                    date: "May 2021 - Oct. 2021",
                    place: "GLOBANT, Tandil, Argentina",
                    info: ["Introduction to the GCP technologies and general knowledge of the Data architect role.",
                    ...
                    info: ["Thesis in Generative Adversarial Neural Networks."],
                    star: true
                }, {
                    ...
                    place: "WeDevelop, Buenos Aires, Argentina",
